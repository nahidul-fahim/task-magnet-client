...
const Testimonials = () => {
    ...
    return (
        <div className="container mx-auto p-5 py-[70px] lg:py-[120px] font-main flex flex-col lg:flex-row justify-center lg:justify-between items-center gap-10"
            style={{
            ...
            <div className="w-full lg:w-3/5 flex flex-col justify-start items-start gap-10 h-full self-stretch">
                ...
                <div className="w-full flex flex-col justify-center items-end mt-[30px] gap-14">
                    ...
                    <div className="flex justify-start items-center gap-5 w-full lg:w-4/5">
                        <button onClick={() => setTestimonial("testimonial1")}><img src={reviewer1} alt="" className="w-[50px] h-[50px] bg-cover rounded-[50%] hover:scale-110 duration-500" /></button>
                        <button onClick={() => setTestimonial("testimonial2")}><img src={reviewer2} alt="" className="w-[50px] h-[50px] bg-cover rounded-[50%] hover:scale-110 duration-500" /></button>
                        <button onClick={() => setTestimonial("testimonial3")}><img src={reviewer3} alt="" className="w-[50px] h-[50px] bg-cover rounded-[50%] hover:scale-110 duration-500" /></button>
                    </div>
